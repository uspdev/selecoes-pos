...
class ParametroRequest extends FormRequest
{
    ...
    public const rules = [
        ...
        'processos_especiais' => ['required', 'max:255'],
    ...
    public const messages = [
        ...
        'processos_especiais.required' => 'O(s) processo(s) para aluno especial é(são) obrigatório(s)!',
        'processos_especiais.max' => 'O(s) processo(s) para aluno especial não pode(m) exceder 255 caracteres!',
